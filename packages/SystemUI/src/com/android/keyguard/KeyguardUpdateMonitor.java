...
public class KeyguardUpdateMonitor implements TrustManager.TrustListener, Dumpable {
    ...
    protected KeyguardUpdateMonitor(
        ...
        mFaceUnlockObserver = new ContentObserver(mHandler) {
            @Override
            public void onChange(boolean selfChange) {
                updateFaceUnlockStatus();
            }
        ...
        mContext.getContentResolver().registerContentObserver(
            Settings.Secure.getUriFor(Settings.Secure.FACE_UNLOCK_METHOD), false, mFaceUnlockObserver, UserHandle.USER_ALL);
    ...
    private void updateFaceUnlockStatus() {
